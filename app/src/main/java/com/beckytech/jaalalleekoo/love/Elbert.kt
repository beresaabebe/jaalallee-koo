...
class Elbert : Fragment() {
    ...
    override fun onCreateView(
        ...
        textContent.text = getString(R.string.friend_is_someone)

        val textAuthor: TextView = view.findViewById(R.id.txtAuthor)

        textAuthor.text = getString(R.string.elbert)

        val image: ImageView = view.findViewById(R.id.imageView)

        image.setImageResource(R.drawable.elbert)
