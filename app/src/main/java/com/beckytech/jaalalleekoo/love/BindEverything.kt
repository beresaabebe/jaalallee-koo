...
class BindEverything : Fragment() {
    ...
    override fun onCreateView(
        ...
        textContent.text = getString(R.string.binds_everything)

        val textAuthor: TextView = view.findViewById(R.id.txtAuthor)

        textAuthor.text = getString(R.string.colossians)

        val image: ImageView = view.findViewById(R.id.imageView)

        image.setImageResource(R.drawable.colosias)
