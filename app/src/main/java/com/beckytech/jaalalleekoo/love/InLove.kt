...
class InLove : Fragment() {
    ...
    override fun onCreateView(
        ...
        textContent.text = getString(R.string.in_love)

        val textAuthor: TextView = view.findViewById(R.id.txtAuthor)

        textAuthor.text = getString(R.string.corinthians)

        val image: ImageView = view.findViewById(R.id.imageView)

        image.setImageResource(R.drawable.corinthians)
