...
class Augustine : Fragment() {
    ...
    override fun onCreateView(
        ...
        textContent.text = getString(R.string.since_love_grows)

        val textAuthor: TextView = view.findViewById(R.id.txtAuthor)

        textAuthor.text = getString(R.string.augustine)

        val image: ImageView = view.findViewById(R.id.imageView)

        image.setImageResource(R.drawable.augustine)
