...
class Martin : Fragment() {
    ...
    override fun onCreateView(
        ...
        textContent.text = getString(R.string.darkness_cannot_drive)

        val textAuthor: TextView = view.findViewById(R.id.txtAuthor)

        textAuthor.text = getString(R.string.martin)

        val image: ImageView = view.findViewById(R.id.imageView)

        image.setImageResource(R.drawable.martin)
