...
class LoveFragmentTwo : Fragment() {
    ...
    override fun onCreateView(
        ...
        textContent.text = getString(R.string.keep_love)

        val textAuthor: TextView = view.findViewById(R.id.txtAuthor)

        textAuthor.text = getString(R.string.oscar)

        val image: ImageView = view.findViewById(R.id.imageView)

        image.setImageResource(R.drawable.oscar)
