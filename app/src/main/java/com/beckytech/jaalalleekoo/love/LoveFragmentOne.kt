...
class LoveFragmentOne : Fragment() {
    ...
    override fun onCreateView(
        ...
        textContent.text = getString(R.string.i_miss_you_mom)

        val textAuthor: TextView = view.findViewById(R.id.txtAuthor)

        textAuthor.text = getString(R.string.mother_teresa)

        val image: ImageView = view.findViewById(R.id.imageView)

        image.setImageResource(R.drawable.teresa)
