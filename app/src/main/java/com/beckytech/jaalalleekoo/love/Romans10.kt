...
class Romans10 : Fragment() {
    ...
    override fun onCreateView(
        ...
        textContent.text = getString(R.string.be_devoted_to)

        val textAuthor: TextView = view.findViewById(R.id.txtAuthor)

        textAuthor.text = getString(R.string.romans_10)

        val image: ImageView = view.findViewById(R.id.imageView)

        image.setImageResource(R.drawable.romans)
