...
class John4 : Fragment() {
    ...
    override fun onCreateView(
        ...
        textContent.text = getString(R.string.there_is_no_fear)

        val textAuthor: TextView = view.findViewById(R.id.txtAuthor)

        textAuthor.text = getString(R.string.John4_18)

        val image: ImageView = view.findViewById(R.id.imageView)

        image.setImageResource(R.drawable.john1)
