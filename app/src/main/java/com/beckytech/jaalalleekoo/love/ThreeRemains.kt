...
class ThreeRemains : Fragment() {
    ...
    override fun onCreateView(
        ...
        textContent.text = getString(R.string.three_remains)

        val textAuthor: TextView = view.findViewById(R.id.txtAuthor)

        textAuthor.text = getString(R.string.corith1313)

        val image: ImageView = view.findViewById(R.id.imageView)

        image.setImageResource(R.drawable.coronthians13)
